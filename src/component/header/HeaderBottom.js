  ...
  return (
    <div className='w-full px-4 h-[36px] bg-amazon_light text-white flex items-center '>
      <ul className='flex items-center  gap-2 text-sm tracking-wide'>
        <li className='headerHover flex items-center' onClick={()=>setSidebar(true)}><MenuIcon/> All</li>
        <li className='headerHover hidden md:inline-flex'>Fresh</li>
        <li className='headerHover hidden md:inline-flex'>Amazon miniTv</li>
        <li className='headerHover hidden md:inline-flex'>Sell</li>
        <li className='headerHover hidden md:inline-flex'>Amazon Pay</li>
        <li className='headerHover hidden md:inline-flex'>Buy Again</li>
      ...
      sidebar && (
        ...
        }} className=' w-[85%] md:w-[350px] h-full bg-white border border-black overflow-y-scroll overflow-x-hidden '>
...
<h3 className='font-titleFont font-bold text-lg tracking-wide'>Hello,Sign In
             ...
             <SideNavContent title="Help & Settings " one=" Your Account " two=" Customer Service"  three="Sign Out"/>
